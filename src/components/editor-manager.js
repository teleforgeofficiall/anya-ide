...
EditorManager.prototype.createEditor = function() {
  ...
  monaco.editor.defineTheme('anya-light', {
    ...
    colors: {
      ...
      'editor.selectionBackground': 'rgba(218,165,32,0.25)',
      'editorCursor.foreground': '#FF69B4',
      'editorLineNumber.foreground': '#d4b8c6',
      'editorLineNumber.activeForeground': '#FF69B4',
      'editor.selectionHighlightBackground': 'rgba(218,165,32,0.12)',
      'editorIndentGuide.background': 'rgba(255,105,180,0.1)',
      'editorIndentGuide.activeBackground': 'rgba(255,105,180,0.18)',
      'editorBracketMatch.background': 'rgba(255,105,180,0.12)',
      ...
      'scrollbarSlider.background': 'rgba(255,105,180,0.12)',
      'scrollbarSlider.hoverBackground': 'rgba(255,105,180,0.22)',
      'scrollbarSlider.activeBackground': 'rgba(255,105,180,0.32)',
